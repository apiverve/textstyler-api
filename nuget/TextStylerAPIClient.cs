...
namespace APIVerve.API.TextStyler
{
    ...
    /// <summary>
    /// Client for the TextStyler API
    /// </summary>
    public class TextStylerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/textstyler";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "style", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public TextStylerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextStylerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextStylerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TextStylerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TextStylerQueryOptions options)
        {
        ...
        public ResponseObj Execute(TextStylerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TextStylerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TextStylerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TextStylerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TextStylerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TextStylerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TextStylerQueryOptions options)
        {
