...
```gradle
dependencies {
    implementation 'com.github.apiverve:textstyler-api:1.1.12'
}
```
...
```java
import com.apiverve.textstyler.TextStylerAPIClient;
import com.apiverve.textstyler.APIResponse;
import com.apiverve.textstyler.APIException;

// Initialize the client
TextStylerAPIClient client = new TextStylerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/textstyler](https://docs.apiverve.com/ref/textstyler)
...
- **Documentation:** [https://docs.apiverve.com/ref/textstyler](https://docs.apiverve.com/ref/textstyler)
- **Issues:** [GitHub Issues](https://github.com/apiverve/textstyler-api/issues)
